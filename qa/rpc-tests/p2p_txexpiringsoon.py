...
class TxExpiringSoonTest(BitcoinTestFramework):
    ...
    def verify_inv(self, testnode, tx):
        ...
        # Send p2p message "mempool" to receive contents from votecoind node in "inv" message
        with mininode_lock:
    ...
    def run_test(self):
        ...
        # Verify mininodes are connected to votecoind nodes
        ...
        # Mininodes send expiring soon transaction in "tx" message to votecoind node
        ...
        # Mininodes send transaction in "tx" message to votecoind node
