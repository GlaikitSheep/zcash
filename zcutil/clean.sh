...
rm -rf test_bitcoin.coverage/ votecoin-gtest.coverage/ total.coverage/
...
clean_exe src/votecoin-cli
clean_exe src/votecoind
clean_exe src/votecoin-gtest
clean_exe src/votecoin-tx
