...
[the VoteCoin protocol spec](https://github.com/votecoin/zips/blob/master/protocol/protocol.pdf),
...
- **Caution:** for z-addresses, these balances will **not** be accurate if any
  ...
  (e.g. [#2542](https://github.com/votecoin/votecoin/issues/2542)).
...
Jack Grigg (40):
      ...
      build: Split hardening/fPIE options out in VoteCoin-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move VoteCoin flags into configure.ac
      ViewingKey -> ReceivingKey per votecoin/zips#117
      ...
      Add watch-only support to VoteCoin RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to votecoin and not bitcoin.
