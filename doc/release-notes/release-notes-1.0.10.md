...
ECDSA signatures inside VoteCoin transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to VoteCoin.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in votecoin-gtest
