...
Alfie John (1):
      Rename libzerocash to libvotecoin
...
Jack Grigg (21):
      ...
      Add VoteCoin revision to version strings
      Bitcoin -> VoteCoin in version and help text
      Add VoteCoin Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-votecoin`` correctly runs the ``votecoin-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the VoteCoin build.
