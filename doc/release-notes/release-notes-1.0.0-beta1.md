...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "VoteCoin" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pvotecoinParams with private member variable
      Revert "Reduce use of global pvotecoinParams with private member variable"
      Replace votecoinParams_ with global.
