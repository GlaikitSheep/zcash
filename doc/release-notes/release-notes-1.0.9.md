...
Jack Grigg (14):
      ...
      Convert VoteCoin versions to Debian format
      ...
      Implement automatic shutdown of deprecated VoteCoin versions
...
Jay Graber (2):
      Change help text examples to use VoteCoin addresses
...
Nathan Wilcox (39):
      ...
      Add all of the votecoin release tags in my current repo as positive test vector.
      ...
      Reuse votecoin_rpc.
      Do not use `-rpcwait` on all `votecoin_rpc` invocations, only block when starting votecoind.
...
emilrus (1):
      Replace bitcoind with votecoind
