...
bitcartel (15):
      ...
      Update URL for votecoin alert IDs.
...
Taylor Hornby (17):
      ...
      Rename zerocash to votecoin in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/votecoin in Makefile.am
      Rename zerocash_packages to votecoin_packages in packages.mk
