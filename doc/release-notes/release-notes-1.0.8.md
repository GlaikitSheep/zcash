...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to votecoind by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for votecoind -help.
...
Jack Grigg (25):
      ...
      Add libevent to votecoin-gtest
...
Jay Graber (5):
      ...
      Add security warning to votecoin-cli --help and --version message output
      Add security warning to votecoind metrics display
