...
------------------------------------------
We include a fix for a bug in the VoteCoind wallet which could result in Sprout
...
“votecoind -rescan”. Sprout address balances shown by the votecoind wallet should
then be correct.
...
[Pull request](https://github.com/votecoin/votecoin/pull/3897)

Miner address selection behaviour fixed
---------------------------------------
VoteCoin inherited a bug from upstream Bitcoin Core where both the internal miner
...
[Mining Guide](https://votecoin.readthedocs.io/en/latest/rtd_pages/votecoin_mining_guide.html)
...
[ZIP draft](https://github.com/votecoin/zips/pull/210).

The consensus rule will be enforced on mainnet in a future release.

[Pull request](https://github.com/votecoin/votecoin/pull/3885)
