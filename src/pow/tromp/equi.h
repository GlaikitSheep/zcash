// Equihash solver
// Copyright (c) 2016-2016 John Tromp, The VoteCoin developers

#ifndef VOTECOIN_POW_TROMP_EQUI_H
#define VOTECOIN_POW_TROMP_EQUI_H
...
#endif // VOTECOIN_POW_TROMP_EQUI_H
