...
typedef std::variant<libvotecoin::SaplingPaymentAddress, CScript> FundingStreamAddress;
...
/**
 * The set of features supported by VoteCoind.
 */
...
struct Params {
     ...
     * using VoteCoin code, the soft fork rule would be enabled from the start so that
