...
/*
    To run tests:
    ./votecoin-gtest --gtest_filter="paymentdisclosure.*"
...
TEST(paymentdisclosure, mainnet) {
    ...
    for (int i=0; i<NUM_TRIES; i++) {
        ...
        info.zaddr = libvotecoin::SproutSpendingKey::random().address();
        ...
        info2.zaddr = libvotecoin::SproutSpendingKey::random().address();        
