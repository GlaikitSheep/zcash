...
} // end namespace `libvotecoin`

typedef libvotecoin::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libvotecoin::SHA256Compress> SproutMerkleTree;
typedef libvotecoin::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvotecoin::SHA256Compress> SproutTestingMerkleTree;

typedef libvotecoin::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libvotecoin::SHA256Compress> SproutWitness;
typedef libvotecoin::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvotecoin::SHA256Compress> SproutTestingWitness;

typedef libvotecoin::IncrementalMerkleTree<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libvotecoin::PedersenHash> SaplingMerkleTree;
typedef libvotecoin::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvotecoin::PedersenHash> SaplingTestingMerkleTree;

typedef libvotecoin::IncrementalWitness<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libvotecoin::PedersenHash> SaplingWitness;
typedef libvotecoin::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvotecoin::PedersenHash> SaplingTestingWitness;
