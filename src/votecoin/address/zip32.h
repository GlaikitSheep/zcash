...
#ifndef VOTECOIN_VOTECOIN_ADDRESS_ZIP32_H
#define VOTECOIN_VOTECOIN_ADDRESS_ZIP32_H
...
struct SaplingExtendedFullViewingKey {
    ...
    uint32_t childIndex;
    uint256 chaincode;
    libvotecoin::SaplingFullViewingKey fvk;
    uint256 dk;
    ...
    libvotecoin::SaplingPaymentAddress DefaultAddress() const;
...
#endif // VOTECOIN_VOTECOIN_ADDRESS_ZIP32_H
