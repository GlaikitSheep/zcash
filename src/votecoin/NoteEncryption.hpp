/*
See the VoteCoin protocol specification for more information.
https://github.com/votecoin/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libvotecoin::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libvotecoin::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libvotecoin::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
