...
const unsigned char VOTECOIN_EXPANDSEED_PERSONALIZATION[BLAKE2bPersonalBytes] = {'Z','c','a','s','h','_','E','x','p','a','n','d','S','e','e','d'};
...
std::array<unsigned char, 64> PRF_expand(const uint256& sk, unsigned char t)
{
    ...
    auto state = blake2b_init(64, VOTECOIN_EXPANDSEED_PERSONALIZATION);
