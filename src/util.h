...
#endif
class missing_votecoin_conf : public std::runtime_error {
public:
    missing_votecoin_conf() : std::runtime_error("Missing votecoin.conf") { }
};
...
{
    std::string s = strprintf("votecoin-%s", name);
